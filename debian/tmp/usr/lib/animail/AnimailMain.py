...
from timeoutsocket import Timeout, setDefaultSocketTimeout
...
class AnimailMain:
        ...
        def main(self, *args):
            ...
            if self.config.reconnect:
                cleanThreadList = []
                for serv in self.config.lservers:
                    if not serv.clean_session and serv.optdelete:
            ...
            try:
                ...
                aprint ("Warning: Error saving the replied list (%s)" % str(x), general.RED, iserror=1)
