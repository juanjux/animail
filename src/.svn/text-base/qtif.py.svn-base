...
#
# Created: Tue Nov 20 23:26:12 2001
...
class window(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        self.ComboBox9 = QComboBox(0,self.tab_misc,'ComboBox9')
        self.ComboBox9.insertItem(self.tr('Smaller messages first'))
        self.ComboBox9.insertItem(self.tr('Bigger messages first'))
        self.ComboBox9.insertItem(self.tr('Server arrival oder'))
        self.ComboBox9.setEnabled(0)
        self.ComboBox9.setGeometry(QRect(120,40,170,22))
        ...
        self.connect(self.check_download_order,SIGNAL('toggled(bool)'),self.ComboBox9,SLOT('setEnabled(bool)'))
        ...
        self.setTabOrder(self.check_download_order,self.ComboBox9)
        self.setTabOrder(self.ComboBox9,self.but_cancel)
